...
public class GetChatContent extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		String receiverUID 	= paramMap.get("receiverUID");
		...
		{					
			...
			{
				historyManager.retriveMessagesFromHistory( null, registryUID, receiverUID, new HistoryManager.RetriveEntriesEventHandler()
				{
					@Override
					public boolean handleEvent( ChatMessageCore chatMessage )
					{					
						if ( chatMessage != null && chatMessage.getContent() != null )
						{		
							resultVect.add( chatMessage );
						}
						return true;
					}
				});
